...
API_ID = int(environ.get('API_ID', '25548765'))
API_HASH = environ.get('API_HASH', '5b151e1c92a755111f516974a3b339ab')
BOT_TOKEN = environ.get('BOT_TOKEN', "8498200979:AAGkfSKfL0bU1ZQt6albx_WaTWa0dhlcuVQ")
...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5360075159').split()] # Replace with the actual admin ID(s) to add
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002271918047').split()]  # Channel id for auto indexing (make sure bot is admin)
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002262848923'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1002262848923'))  # Bin channel id (make sure bot is admin)
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002035457298')  # Channel/Group ID for force sub (make sure bot is admin)
...
AUTH_CHANNEL = [int(fch) if id_pattern.search(fch) else fch for fch in environ.get('AUTH_CHANNEL', '-1002035457298').split()]
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://viboy840:RUiHvhuYuKRLKH39@cluster0.gzb2fe5.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://yasirbaloch0326:A8ekGDZMobuFMUVt@cluster0.slwef.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/morimoflix_zone')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/morimoflix')
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/sire_jones')
